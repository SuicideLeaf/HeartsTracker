...
ANDROID_MANIFEST_FILE=$APPCENTER_SOURCE_DIRECTORY/HeartsTracker.Android/Properties/AndroidManifest.xml
VERSION=${VERSION_NAME}

# Append the branch to the version name when not master. e.g 1.1.0-develop
